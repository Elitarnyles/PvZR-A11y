...
public static class Strings
{
    private static readonly Dictionary<string, string> Defaults = new(StringComparer.Ordinal)
    {
        ...
        ["beghouled.down"] = "down",
        ["beghouled.left"] = "left",
        ["beghouled.right"] = "right",
        ["beghouled.or"] = " or ",
        ["beghouled.can_swap"] = "can move {0}",
        ["beghouled.can_turn"] = "can be turned",
        ["beghouled.swap"] = "Move the {0} at row {1}, column {2}, {3}.",
        ["beghouled.turn_here"] = "Turn the four at row {0}, column {1}.",
        ["beghouled.position"] = "{0} of {1}.",
        ...
        ["tank.fed"] = "Brain dropped {0}. {1} of {2} in the water.",
        ["tank.zombie_at"] = "Zombie {0} of {1}, {2}.",
        ["tank.empty"] = "No zombies left in the tank.",
        ["tank.where"] = "{0}, {1}",
        ["tank.left"] = "left",
        ["tank.right"] = "right",
        ["tank.centre"] = "centre",
        ["tank.high"] = "high",
        ["tank.low"] = "low",
        ["tank.middle"] = "halfway down",
        ["slider.now"] = "{0} percent.",
        ["slider.at_max"] = "Already at the top.",
        ["slider.at_min"] = "Already at the bottom.",
        ["tank.water_full"] = "{0} brains are already in the water.",
        ["tank.too_poor"] = "A brain costs {0} sun and you have {1}.",
        ["tank.not_water"] = "Not over the water.",
        ["tank.no_brain"] = "No brain went in.",
        ["tank.no_tank"] = "No tank here.",
        ["tank.progress"] = "{0} of the {1} sun you need.",
        ["tank.zombies"] = "{0} zombies swimming.",
        ["tank.one_zombie"] = "One zombie left.",
        ["tank.food"] = "{0} of {1} brains in the water.",
        ["tank.no_food"] = "Nothing in the water to eat.",
        ["stand.start"] = "Start Onslaught",
        ["stand.ready"] = "Plan your defence. {0} sun to spend. F5 when ready: {1}.",
        ["stand.ready_unknown"] = "Plan your defence. F5 when ready: {0}.",
        ["stand.planning"] = "Planning. {0} sun to spend. F5 to begin: {1}.",
        ["stand.planning_unknown"] = "Planning. F5 to begin: {0}.",
        ["stand.onslaught"] = "The wave is running.",
        ["stand.no_button"] = "Nothing here would start the wave.",
